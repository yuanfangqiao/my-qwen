...
if __name__ == '__main__':
    ...
    embedding_model_dict = {
        "text2vec": "/home/yuanfangqiao/code/my-qwen1.5/embeddingv2/text2vec-base-chinese",
    }
    # llm = Qwen()
    ...
    qa = RetrievalQA.from_chain_type(
        ...
        retriever=vector.as_retriever(search_kwargs={"k": VECTOR_SEARCH_TOP_K}),
        chain_type_kwargs=chain_type_kwargs)

    #query = "今年是2024年，麻烦算一下今年西安交大建校多少年了"
    query = "西安交大的校训是什么？"
    print(qa.run(query))
